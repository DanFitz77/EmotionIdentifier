...
const emotionWheelData = {
  // Core (innermost)
  core: ["Mad", "Scared", "Joyful", "Powerful", "Peaceful", "Sad",],

  // Middle layer
  middle: {
    Mad: ["Hurt", "Hostile", "Angry", "Rage", "Hateful", "Critical"],
    Scared: ["Rejected", "Confused", "Helpless", "Submissive", "Insecure", "Anxious"],
    Joyful: ["Excited", "Sexy", "Energetic", "Playful", "Creative", "Aware"],
    Powerful: ["Proud", "Respected", "Appreaciated", "Hopeful", "Important", "Faithful"],
    Peaceful: ["Content", "Thoughful", "Intimate", "Loving", "Trusting", "Nuturing"],
    Sad: ["Guilty", "Ashamed", "Depressed", "Lonely", "Boared", "Sleepy"],
  },
  ...
  outer: {
    ...
    Aware: ["Delightful"],
    Proud:["Cheerful"],
    Respected:["Satisified"],
    Appreaciated:["Valuable"],
    Hopeful:["Worthwhile"],
